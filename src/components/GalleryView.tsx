                    ...
                    {item.status === 'loading' ? (
                        ...
                        <>
                            ...
                            <div className="p-3 bg-gray-50 border-t border-gray-100 flex justify-between items-center">
                                <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">Generated by {state.selectedModel.includes('pro') ? 'Nano Banana Pro' : 'Nano Banana'}</span>
